    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          updatedAfter: { type: "string", description: "mtime 起始时间，ISO、可解析日期或相对时间，例如 7d、24h、now-1w" },
          updatedBefore: { type: "string", description: "mtime 结束时间，ISO、可解析日期或相对时间，例如 30d 表示 30 天以前" },
          createdAfter: { type: "string", description: "创建时间起始" },
          createdBefore: { type: "string", description: "创建时间结束" },
          minSize: { anyOf: [{ type: "number", minimum: 0 }, { type: "string" }], description: "最小文件大小，支持字节或 10MB、1.5GB" },
          maxSize: { anyOf: [{ type: "number", minimum: 0 }, { type: "string" }], description: "最大文件大小，支持字节或 10MB、1.5GB" },
